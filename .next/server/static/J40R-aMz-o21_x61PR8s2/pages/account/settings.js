...
module.exports = __webpack_require__("33cx");
...
/* harmony import */ var _components_user_account_form__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("v2Sy");
/* harmony import */ var src_redux_user_actions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("x7is");
/* harmony import */ var _services_index__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("CLrh");
/* harmony import */ var _components_user_update_password_form__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("05yZ");
/* harmony import */ var _services_utils_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("diQs");
var _jsxFileName = "/var/www/admin.dtest.live/pages/account/settings.tsx";
...
class AccountSettings extends react__WEBPACK_IMPORTED_MODULE_0__["PureComponent"] {
  constructor(...args) {
    super(...args);
  ...
  static async getInitialProps({
    ...
    const resp = await _services_utils_service__WEBPACK_IMPORTED_MODULE_9__[/* utilsService */ "a"].countriesList();
  ...
  onAvatarUploaded(data) {
    antd__WEBPACK_IMPORTED_MODULE_3__["message"].success('Avatar has been updated!');
  ...
  async updatePassword(data) {
    try {
      ...
      await _services_index__WEBPACK_IMPORTED_MODULE_7__[/* authService */ "a"].updatePassword(data.password);
      antd__WEBPACK_IMPORTED_MODULE_3__["message"].success('Password has been updated!');
    } catch (e) {
      antd__WEBPACK_IMPORTED_MODULE_3__["message"].error('An error occurred, please try again!');
    } finally {
      this.setState({
        pwUpdating: false
      });
  ...
  render() {
    ...
    const uploadHeaders = {
      authorization: _services_index__WEBPACK_IMPORTED_MODULE_7__[/* authService */ "a"].getToken()
    };
    ...
    }, "Account Settings")), __jsx(_components_common_layout_page__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"], {
      __self: this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 76,
    ...
    }, __jsx(antd__WEBPACK_IMPORTED_MODULE_3__["Tabs"], {
    ...
    }, __jsx(_components_user_account_form__WEBPACK_IMPORTED_MODULE_5__[/* AccountForm */ "a"], {
      onFinish: this.submit.bind(this),
      user: currentUser,
      updating: updating,
      options: {
        uploadHeaders,
        avatarUploadUrl: _services_index__WEBPACK_IMPORTED_MODULE_7__[/* userService */ "k"].getAvatarUploadUrl(),
    ...
    }, __jsx(_components_user_update_password_form__WEBPACK_IMPORTED_MODULE_8__[/* UpdatePaswordForm */ "a"], {
...
const mapDispatch = {
  updateUser: src_redux_user_actions__WEBPACK_IMPORTED_MODULE_6__[/* updateUser */ "f"],
  updateCurrentUserAvatar: src_redux_user_actions__WEBPACK_IMPORTED_MODULE_6__[/* updateCurrentUserAvatar */ "e"]
};
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_2__["connect"])(mapStates, mapDispatch)(AccountSettings));
