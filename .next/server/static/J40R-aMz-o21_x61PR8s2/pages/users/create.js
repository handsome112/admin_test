...
module.exports = __webpack_require__("Kcfj");
...
/* harmony import */ var _components_user_account_form__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("v2Sy");
var _jsxFileName = "/var/www/admin.dtest.live/pages/users/create.tsx";
...
class UserCreate extends react__WEBPACK_IMPORTED_MODULE_0__["PureComponent"] {
  constructor(...args) {
    super(...args);
  ...
  static async getInitialProps() {
    const resp = await _services_utils_service__WEBPACK_IMPORTED_MODULE_6__[/* utilsService */ "a"].countriesList();
    return {
      countries: resp.data
    };
  }
  ...
  async submit(data) {
    try {
      ...
      const resp = await _services_index__WEBPACK_IMPORTED_MODULE_5__[/* userService */ "k"].create(data);
      antd__WEBPACK_IMPORTED_MODULE_2__["message"].success('Updated successfully');

      if (this._avatar) {
        await _services_index__WEBPACK_IMPORTED_MODULE_5__[/* userService */ "k"].uploadAvatarUser(this._avatar, resp.data._id);
      }

      next_router__WEBPACK_IMPORTED_MODULE_4___default.a.push(`/users/update?id=${resp.data._id}`);
    } catch (e) {
  ...
  render() {
    ...
    const uploadHeaders = {
      authorization: _services_index__WEBPACK_IMPORTED_MODULE_5__[/* authService */ "a"].getToken()
    };
    ...
    }, "Create user")), __jsx(_components_common_layout_page__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"], {
      __self: this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 90,
    ...
    }, __jsx(_components_user_account_form__WEBPACK_IMPORTED_MODULE_8__[/* AccountForm */ "a"], {
